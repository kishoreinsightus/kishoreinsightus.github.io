...
let MCQChoiceMatrixComponent = class MCQChoiceMatrixComponent {
    constructor(router, route, questionService, pluginService, changedetector) {
        this.router = router;
        this.route = route;
        this.questionService = questionService;
        this.pluginService = pluginService;
...
let CurriculumAdditionalResourcesManageComponent = class CurriculumAdditionalResourcesManageComponent {
    constructor(_router, activatedRoute, addlResourceService, curriculumService, subjectService, organisationService, eventManager, parseLinks, principalService, pluginService, formBuilder, userLoginInfo, commonService, changeDetectorRef, fileService) {
    ...
    onGradeChange() {
        ...
        if (this.selectedGrade) {
            ...
            this.subjectService
                .getSubjectByCurriculumIdAndGradeId(curriculumId, gradeId, status)
                .subscribe((res) => this.assignSubjectList(res.body), (res) => this.onError(res.message));
        }
        this.selectedSubject = null;
    }
    ...
    loadSubjectTree() {
        if (this.selectedSubject) {
            ...
            if (subjectId) {
                this.subjectService.getSubjectTreeBySubjectId(subjectId).subscribe((res) => this.assignSubjectTree(res.body), (res) => this.onError(res.message));
            }
            else {
    ...
    getAddlResourceList(lessonId) {
        this.addlResourceService.getAddlResource(lessonId).subscribe((res) => this.assignResponseToAddlResourceList(res.body), (res) => this.onError(res.message));
    }
    ...
    getOrgGeneralAddlResourceByOrganisation() {
        ...
        this.addlResourceService.getOrgGeneralAddlResourceByOrganisationId(this.lessonId, organisationId).subscribe((res) => this.assignResponseToOrgAddlResource(res.body), (res) => this.onError(res.message));
    }
    ...
    getOrgGeneralAddlResourceByOrganisationId(lessonId) {
        ...
        this.addlResourceService.getOrgGeneralAddlResourceByOrganisationId(lessonId, this.organisationId).subscribe((res) => this.assignResponseToOrgAddlResourceList(res.body), (res) => this.onError(res.message));
    }
    ...
    getOrganisationList() {
        this.organisationService.getOrganisations().subscribe((res) => this.assignOrgList(res.body), (res) => this.onError(res.message));
    }
    assignOrgList(data) {
    ...
    getAddlResourcePreference(lessonId) {
        this.addlResourceService.getAddlResourcePreference(lessonId, this.organisationId).subscribe((res) => this.onGetPreferenceSuccess(res.body), (res) => this.onError(res.message));
    }
    ...
    setContentPreference() {
        this.addlResourceService.setAddlResourcePreference(this.contentPreferenceStatus, this.lessonId, this.organisationId).subscribe((res) => this.onSuccess(res.body), (res) => this.onError(res.message));
    }
    onSuccess(data) {
    ...
    saveAddlResource() {
        if (this.lessonResourceForm.valid) {
            ...
            this.addlResourceService.saveAddlResource(addlResources).subscribe((res) => this.onSaveSuccess(res.body), (res) => this.onSaveError(res.error));
        }
        if (this.lessonResourceForm.invalid) {
            return;
        }
    ...
    saveOwnAddlResource() {
        if (this.lessonResourceForm.valid) {
            ...
            this.addlResourceService.saveOwnAddlResource(orgGeneralAddlResources).subscribe((res) => this.onSaveSuccess(res.body), (res) => this.onSaveError(res.error));
        }
        if (this.lessonResourceForm.invalid) {
            return;
        }
    ...
    subscribeToUpdateAddlResouceResponse(result) {
        result.subscribe((res) => this.onUpdateAddlSuccess(res), (errRes) => this.onUpdateTopicContentError(errRes));
    }
    ...
    subscribeToUpdateOwnAddlResouceResponse(result) {
        result.subscribe((res) => this.onUpdateOwnAddlSuccess(res), (errRes) => this.onUpdateTopicContentError(errRes));
    }
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _syllabus_lesson_topic_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../syllabus-lesson-topic.service */ "./src/app/syllabus-lesson-topic/syllabus-lesson-topic.service.ts");



let LessonPlanManageComponent = class LessonPlanManageComponent {
    constructor() {
    }
    ngOnInit() {
    }
...
LessonPlanManageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./lesson-plan-manage.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/syllabus-lesson-topic/lesson-plan/lesson-plan-manage.component.html")).default,
...
let LessonTopicManageComponent = class LessonTopicManageComponent {
    constructor(_router, activatedRoute, curriculumService, subjectService, lessonTopicService, eventManager, parseLinks, principalService, pluginService, generalSubjectService, formBuilder) {
        this._router = _router;
        this.activatedRoute = activatedRoute;
        this.curriculumService = curriculumService;
        this.subjectService = subjectService;
    ...
    getLessonTopicList(lessonId) {
        this.lessonTopicService
            ...
            .subscribe((res) => this.assignLessonTopicsList(res.body), (res) => this.onError(res.message));
    }
    ...
    getTopicDetails(topicId, index) {
        this.lessonTopicService
            ...
            .subscribe((res) => this.assignTopicDetailList(res.body, index), (res) => this.onError(res.message));
    }
    assignTopicDetailList(data, index) {
    ...
    loadGeneralSubjectList() {
        this.generalSubjectService.getSubjectSearchList().subscribe((res) => this.assignGeneralSubjectList(res.body), (res) => this.onError(res.message));
    }
    ...
    loadGeneralSubjectTree() {
        ...
        if (this.selectedGeneralSubject) {
            ...
            this.generalSubjectService.getSubjectTreeBySubjectId(generalSubjectId).subscribe((res) => this.assignGeneralSubjectTree(res.body), (res) => this.onError(res.message));
        }
    }
    ...
    onUpdateLessonTopicError(errRes) {
        this.pluginService.alertMessage("Could not update, please contact admin", "error");
    }
...
let PrerequisiteLessonTopicManageComponent = class PrerequisiteLessonTopicManageComponent {
    constructor(_router, activatedRoute, curriculumService, subjectService, lessonTopicService, eventManager, parseLinks, principalService, generalSubjectService, pluginService) {
        this._router = _router;
        this.activatedRoute = activatedRoute;
        this.curriculumService = curriculumService;
        this.subjectService = subjectService;
...
/* harmony import */ var _lesson_plan_lesson_plan_manage_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./lesson-plan/lesson-plan-manage.component */ "./src/app/syllabus-lesson-topic/lesson-plan/lesson-plan-manage.component.ts");
...
let SyllabusLessonTopicService = class SyllabusLessonTopicService {
    ...
    deleteOwnTopicQuestions(questionIds) {
...
let CurriculumTopicContentManageComponent = class CurriculumTopicContentManageComponent {
    constructor(_router, activatedRoute, subjectService, curriculumService, organisationService, topicContentService, eventManager, parseLinks, principalService, formBuilder, pluginService, userLoginService, commonService, changeDetectRef, fileService) {
        this._router = _router;
        this.activatedRoute = activatedRoute;
        this.subjectService = subjectService;
        this.curriculumService = curriculumService;
    ...
    getTopicContentList(generalTopicId) {
        this.topicContentService.getTopicDetails(generalTopicId).subscribe((res) => this.assignResponseToTopicList(res.body), (res) => this.onError(res.message));
    }
    ...
    getOrgGeneralTopicContentByOrganisationId(generalTopicId) {
        ...
        this.topicContentService.getOrgGeneralTopicContentsByOrgId(generalTopicId, this.organisationId).subscribe((res) => this.assignResponseToOrgTopicList(res.body), (res) => this.onError(res.message));
    }
    ...
    getOrgTopicContentByOrgId() {
        let organisationId = this.selectedOrganisation.id;
        this.topicContentService.getOrgGeneralTopicContentsByOrgId(this.generalTopicId, organisationId).subscribe((res) => this.assignResponseToOrgTopicContentListByOrgId(res.body), (res) => this.onError(res.message));
    }
    ...
    setContentPreference() {
        this.topicContentService.setContentPreference(this.contentPreferenceStatus, this.generalTopicId, this.organisationId).subscribe((res) => this.onSuccess(res.body), (res) => this.onError(res.message));
    }
    onSuccess(data) {
        this.pluginService.alertMessage("Content preference saved successfully", "success");
    }
    getContentPreference(generalTopicId) {
        ...
        this.topicContentService.getContentPreference(orgId, generalTopicId).subscribe((res) => this.onGetPreferenceSuccess(res.body), (res) => this.onError(res.message));
    }
    onGetPreferenceSuccess(acitveStatus) {
        if (acitveStatus === "" || acitveStatus === null || acitveStatus === false) {
            this.checkContentCE = true;
...
let CurriculumTopicQuestionCreateComponent = class CurriculumTopicQuestionCreateComponent {
    constructor(activatedRoute, router, pluginService, questionBuilderService, questionService, formBuilder, userLoginService, commonService, changedetector) {
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.pluginService = pluginService;
    ...
    saveQuestion() {
        let questionResource = {}, questionDetails, updatedQuestionResource;
...
let CurriculumTopicQuestionDetailsComponent = class CurriculumTopicQuestionDetailsComponent {
    constructor(activatedRoute, router, pluginService, questionBuilderService, questionService, formBuilder, userLoginService) {
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.pluginService = pluginService;
        this.questionBuilderService = questionBuilderService;
    ...
    getQuestionDetail(questionId) {
        this.questionService
            ...
            .subscribe((res) => this.assignQuestionResource(res.body), (res) => this.onError(res.message));
    }
...
let CurriculumTopicQuestionManageComponent = class CurriculumTopicQuestionManageComponent {
    constructor(_router, activatedRoute, curriculumService, organisationService, subjectService, topicQuestionService, eventManager, parseLinks, principalService, pluginService, userLoginService, questionBuilderService) {
        this._router = _router;
        this.activatedRoute = activatedRoute;
        this.curriculumService = curriculumService;
        this.organisationService = organisationService;
    ...
    getTopicQuestionList(generalTopicId) {
        this.topicQuestionService.getTopicDetails(generalTopicId).subscribe((res) => this.assignResponseToTopicQuestionList(res.body), (res) => this.onError(res.message));
    }
    ...
    getOrgGeneralTopicQuestionByOrganisationId(generalTopicId) {
        //User login Information for organisationId 
        this.organisationId = this.userLoginService.organisationId;
        this.topicQuestionService.getOrgGeneralTopicQuestionsByOrgId(generalTopicId, this.organisationId).subscribe((res) => this.assignResponseToOrgTopicQuestionList(res.body), (res) => this.onError(res.message));
    }
    ...
    getOrgTopicQuestiontByOrgId() {
        let organisationId = this.selectedOrganisation.id;
        this.topicQuestionService.getOrgGeneralTopicQuestionsByOrgId(this.generalTopicId, organisationId).subscribe((res) => this.assignResponseToOrgTopicQuestionListByOrgId(res.body), (res) => this.onError(res.message));
    }
    assignResponseToOrgTopicQuestionListByOrgId(data) {
    ...
    getQuestionPreference(generalTopicId) {
        //User login Information for organisationId 
        let orgId = this.userLoginService.organisationId;
        this.topicQuestionService.getQuestionPreference(orgId, generalTopicId).subscribe((res) => this.onGetPreferenceSuccess(res.body), (res) => this.onError(res.message));
    }
    onGetPreferenceSuccess(acitveStatus) {
        if (acitveStatus === "" || acitveStatus === null || acitveStatus === false) {
    ...
    setQuestionPreference() {
        this.topicQuestionService.setQuestionPreference(this.questionPreferenceStatus, this.generalTopicId, this.organisationId).subscribe((res) => this.onSuccess(res.body), (res) => this.onError(res.message));
    }
    onSuccess(data) {
...
let CurriculumTopicQuestionUpdateComponent = class CurriculumTopicQuestionUpdateComponent {
    constructor(activatedRoute, router, pluginService, questionBuilderService, questionService, formBuilder, userLoginService, commonService) {
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.pluginService = pluginService;
        this.questionBuilderService = questionBuilderService;
