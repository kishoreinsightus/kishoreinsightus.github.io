...
let CurriculumAffiliationsComponent = class CurriculumAffiliationsComponent {
    constructor(_router, curriculumService, eventManager, parseLinks, principalService, pluginService, errorHandler, activatedRoute) {
    ...
    loadCurriculumAffiliations(curriculumId) {
        this.curriculumService
            .getAffiliationsByCurriculumId(curriculumId)
            .subscribe((res) => this.paginateCurriculumAffiliations(res.body, res.headers), (res) => this.onError(res));
    }
    paginateCurriculumAffiliations(data, headers) {
...
CurriculumAffiliationsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
        _curriculum_service__WEBPACK_IMPORTED_MODULE_1__["CurriculumService"],
...
let CurriculumCreateComponent = class CurriculumCreateComponent {
    constructor(router, activatedRoute, curriculumService, eventManager, pluginService, formBuilder, commonService, changeDetectRef, errorHandler) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.curriculumService = curriculumService;
        this.eventManager = eventManager;
    ...
    subscribeToSaveResponse(result) {
        result.subscribe((res) => this.onSaveCurriculumSuccess(), (res) => this.onError(res));
    }
...
let CurriculumDeleteComponent = class CurriculumDeleteComponent {
    constructor(router, activatedRoute, eventManager, curriculumService, pluginService, errorHandler) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.eventManager = eventManager;
        this.curriculumService = curriculumService;
    ...
    subscribeToDeleteCurriculumResponse(resp) {
        resp.subscribe((res) => this.onDeleteCurriculumSuccess(res), (res) => this.onError(res));
    }
    //Delete curriculum
...
let CurriculumDetailsComponent = class CurriculumDetailsComponent {
    constructor(router, activatedRoute, pluginService, commonService) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.pluginService = pluginService;
        this.commonService = commonService;
...
let CurriculumManageComponent = class CurriculumManageComponent {
    constructor(_router, curriculumService, eventManager, parseLinks, principalService, pluginService, errorHandler) {
        this._router = _router;
        this.curriculumService = curriculumService;
        this.eventManager = eventManager;
        this.parseLinks = parseLinks;
    ...
    loadStandardCurriculums() {
        this.curriculumService
            ...
            .subscribe((res) => this.paginateCurriculums(res.body, res.headers), (res) => this.onError(res));
    }
...
let CurriculumPublishComponent = class CurriculumPublishComponent {
    constructor(router, activatedRoute, curriculumService, pluginService, errorHandler) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.curriculumService = curriculumService;
        this.pluginService = pluginService;
...
let CurriculumUpdateComponent = class CurriculumUpdateComponent {
    constructor(router, activatedRoute, curriculumService, eventManager, pluginService, formBuilder, commonService, changeDetectorRef, errorHandler) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.curriculumService = curriculumService;
        this.eventManager = eventManager;
...
/* harmony import */ var _curriculum_route__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./curriculum.route */ "./src/app/curriculum/curriculum.route.ts");
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index */ "./src/app/curriculum/index.ts");
...
CurriculumModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(_curriculum_route__WEBPACK_IMPORTED_MODULE_8__["curriculumRoute"]),
        ...
        declarations: [
            _index__WEBPACK_IMPORTED_MODULE_9__["CurriculumManageComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["CurriculumCreateComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["CurriculumUpdateComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["CurriculumDetailsComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["CurriculumDeleteComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["CurriculumPublishComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["CurriculumUnpublishComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["CurriculumAffiliationsComponent"]
        ],
...
let CurriculumResolve = class CurriculumResolve {
    ...
    resolve(route, state) {
        ...
        if (id) {
            return this.service.getCurriculumByCurriculumId(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])((response) => response.ok), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((curriculum) => curriculum.body));
        }
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _curriculum_affiliations_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./curriculum-affiliations.component */ "./src/app/curriculum/curriculum-affiliations.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CurriculumAffiliationsComponent", function() { return _curriculum_affiliations_component__WEBPACK_IMPORTED_MODULE_1__["CurriculumAffiliationsComponent"]; });

/* harmony import */ var _curriculum_manage_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./curriculum-manage.component */ "./src/app/curriculum/curriculum-manage.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CurriculumManageComponent", function() { return _curriculum_manage_component__WEBPACK_IMPORTED_MODULE_2__["CurriculumManageComponent"]; });

/* harmony import */ var _curriculum_update_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./curriculum-update.component */ "./src/app/curriculum/curriculum-update.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CurriculumUpdateComponent", function() { return _curriculum_update_component__WEBPACK_IMPORTED_MODULE_3__["CurriculumUpdateComponent"]; });

/* harmony import */ var _curriculum_create_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./curriculum-create.component */ "./src/app/curriculum/curriculum-create.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CurriculumCreateComponent", function() { return _curriculum_create_component__WEBPACK_IMPORTED_MODULE_4__["CurriculumCreateComponent"]; });

/* harmony import */ var _curriculum_details_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./curriculum-details.component */ "./src/app/curriculum/curriculum-details.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CurriculumDetailsComponent", function() { return _curriculum_details_component__WEBPACK_IMPORTED_MODULE_5__["CurriculumDetailsComponent"]; });

/* harmony import */ var _curriculum_delete_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./curriculum-delete.component */ "./src/app/curriculum/curriculum-delete.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CurriculumDeleteComponent", function() { return _curriculum_delete_component__WEBPACK_IMPORTED_MODULE_6__["CurriculumDeleteComponent"]; });

/* harmony import */ var _curriculum_update_publish_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./curriculum-update-publish.component */ "./src/app/curriculum/curriculum-update-publish.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CurriculumPublishComponent", function() { return _curriculum_update_publish_component__WEBPACK_IMPORTED_MODULE_7__["CurriculumPublishComponent"]; });

/* harmony import */ var _curriculum_update_unpublish_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./curriculum-update-unpublish.component */ "./src/app/curriculum/curriculum-update-unpublish.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CurriculumUnpublishComponent", function() { return _curriculum_update_unpublish_component__WEBPACK_IMPORTED_MODULE_8__["CurriculumUnpublishComponent"]; });

/* harmony import */ var _curriculum_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./curriculum.service */ "./src/app/curriculum/curriculum.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CurriculumService", function() { return _curriculum_service__WEBPACK_IMPORTED_MODULE_9__["CurriculumService"]; });
