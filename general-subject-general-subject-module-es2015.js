...
let GeneralSubjectCreateComponent = class GeneralSubjectCreateComponent {
    constructor(router, formBuilder, pluginService, curriculumService, generalSubjectService, activatedRoute, commonService, changeDetectRef, errorHandler) {
        this.router = router;
    ...
    getCurriculumList() {
        this.curriculumService.getStandardCurriculums().subscribe((res) => this.assignResponseToList(res.body), (res) => this.onError(res));
    }
...
let GeneralSubjectDeleteComponent = class GeneralSubjectDeleteComponent {
    constructor(router, activatedRoute, eventManager, generalSubjectService, pluginService, errorHandler) {
        this.router = router;
        this.activatedRoute = activatedRoute;
...
let GeneralSubjectDetailsComponent = class GeneralSubjectDetailsComponent {
    constructor(pluginService, curriculumService, generalSubjectService, activatedRoute, router, errorHandler) {
        this.pluginService = pluginService;
        this.curriculumService = curriculumService;
        this.generalSubjectService = generalSubjectService;
        this.activatedRoute = activatedRoute;
...
let GeneralSubjectManageComponent = class GeneralSubjectManageComponent {
    constructor(_router, generalSubjectService, eventManager, parseLinks, principalService, pluginService, errorHandler) {
    ...
    loadGeneralSubjects() {
        this.generalSubjectService
            ...
            .subscribe((res) => this.paginateGeneralSubjects(res.body, res.headers), (res) => this.onError(res));
    }
...
let GeneralSubjectPublishComponent = class GeneralSubjectPublishComponent {
    constructor(router, activatedRoute, generalSubjectService, pluginService, errorHandler) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.generalSubjectService = generalSubjectService;
        this.pluginService = pluginService;
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index */ "./src/app/general-subject/index.ts");
...
GeneralSubjectsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(_general_subject_route__WEBPACK_IMPORTED_MODULE_8__["generalSubjectRoute"]),
        ...
        declarations: [
            _index__WEBPACK_IMPORTED_MODULE_9__["GeneralSubjectManageComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["GeneralSubjectCreateComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["GeneralSubjectUpdateComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["GeneralSubjectDetailsComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["GeneralSubjectDeleteComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["GeneralSubjectPublishComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["GeneralSubjectUnpublishComponent"]
        ],
...
/* harmony import */ var _general_subject_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./general-subject.service */ "./src/app/general-subject/general-subject.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GeneralSubjectService", function() { return _general_subject_service__WEBPACK_IMPORTED_MODULE_8__["GeneralSubjectService"]; });
