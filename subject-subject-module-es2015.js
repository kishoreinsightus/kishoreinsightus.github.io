...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _subject_create_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./subject-create.component */ "./src/app/subject/subject-create.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SubjectCreateComponent", function() { return _subject_create_component__WEBPACK_IMPORTED_MODULE_1__["SubjectCreateComponent"]; });

/* harmony import */ var _subject_update_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./subject-update.component */ "./src/app/subject/subject-update.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SubjectUpdateComponent", function() { return _subject_update_component__WEBPACK_IMPORTED_MODULE_2__["SubjectUpdateComponent"]; });

/* harmony import */ var _subject_details_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./subject-details.component */ "./src/app/subject/subject-details.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SubjectDetailsComponent", function() { return _subject_details_component__WEBPACK_IMPORTED_MODULE_3__["SubjectDetailsComponent"]; });

/* harmony import */ var _subject_manage_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./subject-manage.component */ "./src/app/subject/subject-manage.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SubjectManageComponent", function() { return _subject_manage_component__WEBPACK_IMPORTED_MODULE_4__["SubjectManageComponent"]; });

/* harmony import */ var _subject_delete_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./subject-delete.component */ "./src/app/subject/subject-delete.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SubjectDeleteComponent", function() { return _subject_delete_component__WEBPACK_IMPORTED_MODULE_5__["SubjectDeleteComponent"]; });

/* harmony import */ var _subject_update_publish_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./subject-update-publish.component */ "./src/app/subject/subject-update-publish.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SubjectPublishComponent", function() { return _subject_update_publish_component__WEBPACK_IMPORTED_MODULE_6__["SubjectPublishComponent"]; });

/* harmony import */ var _subject_update_unpublish_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./subject-update-unpublish.component */ "./src/app/subject/subject-update-unpublish.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SubjectUnpublishComponent", function() { return _subject_update_unpublish_component__WEBPACK_IMPORTED_MODULE_7__["SubjectUnpublishComponent"]; });

/* harmony import */ var _subject_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./subject.service */ "./src/app/subject/subject.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SubjectService", function() { return _subject_service__WEBPACK_IMPORTED_MODULE_8__["SubjectService"]; });
...
let SubjectCreateComponent = class SubjectCreateComponent {
    constructor(router, formBuilder, pluginService, curriculumService, subjectService, activatedRoute, commonService, changeDetectRef, errorHandler) {
        this.router = router;
...
let SubjectDeleteComponent = class SubjectDeleteComponent {
    constructor(router, activatedRoute, eventManager, subjectService, pluginService, errorHandler) {
        this.router = router;
        this.activatedRoute = activatedRoute;
...
let SubjectManageComponent = class SubjectManageComponent {
    constructor(_router, activatedRoute, curriculumService, subjectService, eventManager, parseLinks, principalService, pluginService, errorHandler) {
    ...
    loadSubjectList() {
        ...
        if (this.selectedCurriculum && this.selectedGrade) {
            this.subjectService
                ...
                .subscribe((res) => this.paginateSubjects(res.body, res.headers), (res) => this.onError(res));
        }
        else {
...
let SubjectPublishComponent = class SubjectPublishComponent {
    constructor(router, activatedRoute, subjectService, pluginService, errorHandler) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.subjectService = subjectService;
        this.pluginService = pluginService;
...
let SubjectUpdateComponent = class SubjectUpdateComponent {
    constructor(router, formBuilder, pluginService, subjectService, activatedRoute, commonService, changeDetectRef, errorHandler) {
        this.router = router;
        this.formBuilder = formBuilder;
        this.pluginService = pluginService;
        this.subjectService = subjectService;
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index */ "./src/app/subject/index.ts");
...
SubjectModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [
            _index__WEBPACK_IMPORTED_MODULE_9__["SubjectManageComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["SubjectCreateComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["SubjectUpdateComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["SubjectDetailsComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["SubjectDeleteComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["SubjectPublishComponent"],
            _index__WEBPACK_IMPORTED_MODULE_9__["SubjectUnpublishComponent"]
        ],
        providers: [
            _index__WEBPACK_IMPORTED_MODULE_9__["SubjectService"]
        ],
