...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["general-concept-topic-general-concept-topic-module"], {
  ...
  function srcAppGeneralConceptTopicGeneralConceptTopicModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _general_concept_topic_route__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var ng_jhipster__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ng-jhipster */
    ...
    var _general_topic_question_create_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./general-topic-question-create.component */
    "./src/app/general-concept-topic/general-topic-question-create.component.ts");
    /* harmony import */


    var _question_builder_question_builder_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../question-builder/question-builder.module */
    "./src/app/question-builder/question-builder.module.ts");
    /* harmony import */


    var _general_topic_content_manage_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./general-topic-content-manage.component */
    "./src/app/general-concept-topic/general-topic-content-manage.component.ts");
    /* harmony import */


    var _syllabus_lesson_topic_syllabus_lesson_topic_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    ...
    GeneralConceptAndTopicModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_question_builder_question_builder_module__WEBPACK_IMPORTED_MODULE_11__["QuestionBuilderModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["ReactiveFormsModule"], _shared__WEBPACK_IMPORTED_MODULE_8__["SharedModule"], ng_jhipster__WEBPACK_IMPORTED_MODULE_7__["NgJhipsterModule"], ngx_infinite_scroll__WEBPACK_IMPORTED_MODULE_6__["InfiniteScrollModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(_general_concept_topic_route__WEBPACK_IMPORTED_MODULE_4__["generalConceptAndTopicRoute"]), _syllabus_lesson_topic_syllabus_lesson_topic_module__WEBPACK_IMPORTED_MODULE_13__["SyllabusLessonTopicModule"]],
      declarations: [_general_topic_content_manage_component__WEBPACK_IMPORTED_MODULE_12__["GeneralTopicContentManageComponent"], _general_topic_question_manage_component__WEBPACK_IMPORTED_MODULE_2__["GeneralTopicQuestionManageComponent"], _general_topic_question_create_component__WEBPACK_IMPORTED_MODULE_10__["GeneralTopicQuestionCreateComponent"]],
    ...
    function () {
      ...
      _createClass(GeneralConceptAndTopicService, [{
        ...
        value: function getTopicContentList(id) {
          return this.http.get("".concat(this.generalTopicsResourceUrl, "/").concat(id), {
            observe: 'response'
          });
        }
      }, {
        ...
        value: function deleteTopicQuestions(questionIds) {
          return this.http["delete"]("".concat(this.questionResourceUrl, "/", "batch", "/").concat(questionIds), {
            observe: 'response'
          });
        }
      }]);
  ...
  function srcAppGeneralConceptTopicGeneralTopicContentManageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(GeneralTopicContentManageComponent, [{
        ...
        key: "loadSubjectData",
        value: function loadSubjectData() {
          var _this3 = this;

          this.generalSubjectService.getSubjectSearchList().subscribe(function (res) {
            return _this3.assignResponseToList(res.body);
          }, function (res) {
            return _this3.onError(res.message);
          });
        }
      }, {
        ...
        value: function getTopicContentList(topicId) {
          ...
          this.generalTopicContentService.getTopicContentList(topicId).subscribe(function (res) {
            return _this4.assignResponseToTopicList(res.body);
          }, function (res) {
          ...
          if (this.selectedSubject === null || this.selectedSubject === undefined) {
            ...
            if (subjectId) {
              this.generalSubjectService.getSubjectTreeBySubjectId(subjectId).subscribe(function (res) {
                ...
                return _this5.onError(res.message);
              });
            }
          }
        }
        ...
        value: function assignResponsetoTree(data) {
        ...
        value: function subscribeToDownloadResponse(result) {
          ...
          result.subscribe(function (res) {
            ...
            return _this8.onDownloadError(errRes);
          });
        }
      }, {
        ...
        value: function subscribeToSaveResponse(result) {
          ...
          result.subscribe(function (res) {
            ...
            return _this9.onSaveError(errRes);
          });
        }
      }, {
        key: "onSaveSuccess",
        ...
        value: function subscribeToDeleteFiletResponse(resp) {
          ...
          resp.subscribe(function (res) {
            ...
            return _this10.onDeleteError(res);
          });
        }
      }, {
        ...
        value: function subscribeToUpdateResponse(result) {
          ...
          result.subscribe(function (res) {
            ...
            return _this11.onUpdateError(errRes);
          });
        }
      }, {
        key: "onUpdateSuccess",
        ...
        key: "cancelTopicContent",
        value: function cancelTopicContent() {
          this.resetFormValues();
        }
      }, {
        ...
        value: function subscribeToDeleteResponse(result) {
          ...
          result.subscribe(function (res) {
            ...
            return _this12.onDeleteError(errRes);
          });
        }
      }, {
        key: "onDeleteSuccess",
        ...
        value: function subscribeToUpdateTopicContentResponse(result) {
          ...
          result.subscribe(function (res) {
            ...
            return _this14.onUpdateTopicContentError(errRes);
          });
        }
      }, {
      ...
      _createClass(GeneralTopicQuestionCreateComponent, [{
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 15:
                    updatedHTMLData = _context2.sent;
                  ...
                  case 22:
                    return _context2.abrupt("return", updatedHTMLData);
        ...
        value: function subscribeToSaveResponse(result) {
          ...
          result.subscribe(function (resp) {
            ...
            return _this21.onSaveError(errRes);
          });
        }
      }, {
        key: "onSaveSuccess",
    ...
    function () {
      ...
      _createClass(GeneralTopicQuestionManageComponent, [{
        ...
        value: function loadSubjectData() {
          ...
          this.generalSubjectService.getSubjectSearchList().subscribe(function (res) {
            return _this22.assignResponseToList(res.body);
          }, function (res) {
        ...
        value: function getTopicQuestionsList(topicId) {
          ...
          this.generalTopicQuestionService.getTopicQuestionList(topicId).subscribe(function (res) {
            return _this23.assignResponseToQuestionList(res.body);
          }, function (res) {
        ...
        key: "resetSelectedTopicQuestion",
        value: function resetSelectedTopicQuestion() {
          this.questionIds = [];
          this.tableAction = true;
          $(".checkAll").prop("checked", false);
        }
      }, {
        key: "checkSelectedQuestions",
        value: function checkSelectedQuestions(event) {
          var selectedId, checked, index;
          checked = event.target.checked;
          selectedId = event.target.id;
        ...
        value: function subscribeToDeleteResponse(result) {
          ...
          result.subscribe(function (res) {
            ...
            return _this25.onDeleteError(errRes);
          });
        }
      }, {
        key: "onDeleteSuccess",
